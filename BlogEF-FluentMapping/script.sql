...
VALUES (N'20230928114017_InitialCreation', N'7.0.11');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230928115328_AdicionadoCampoGitHub', N'7.0.11');
GO
...
ALTER TABLE [User] ADD [Badge] nvarchar(max) NOT NULL DEFAULT N'';
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230928115918_AdicionaCampoUser', N'7.0.11');
GO
